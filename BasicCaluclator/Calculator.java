    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == subButton){
         ...
         if (e.getSource() == delButton){
            ...
            String deletionString = textfield.getText();

            textfield.setText("");

            for (int d = 0; d < deletionString.length() -1; d++){

                textfield.setText(textfield.getText() + deletionString.charAt(d));
